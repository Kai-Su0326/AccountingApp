...
public class GlobalUtil {
    private static GlobalUtil instance = null;
    ...
    public LinkedList<CategoryResBean> incomeRes = new LinkedList<>();
    ...
    public void setContext(Context context) {
        ...
        databaseHelper = new RecordDatabaseHelper(context,RecordDatabaseHelper.DB_NAME,null,2); //todo: challenge: 更改数据库版本号
    ...
    public int getResourceIcon(String category){
        ...
        for(CategoryResBean res : incomeRes){
            if(res.title.equals(category)){
                return res.resWhite;
            }
        }
